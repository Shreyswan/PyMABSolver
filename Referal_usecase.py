...
sol = pm.MABSolver(n=5, t=500, tf=200, eps=0.01)
...
sol.plot_comparison(avg_rew_list_expr=avg_rew_list_expr, avg_rew_list_expl=avg_rew_list_expl, avg_rew_list_fege=avg_rew_list_fege, avg_rew_list_eps=avg_rew_list_eps)